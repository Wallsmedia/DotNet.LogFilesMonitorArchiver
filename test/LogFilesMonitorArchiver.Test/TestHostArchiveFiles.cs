...
public class TestHostArchiveFiles
{
    ...
    public void Test_HostingOfLogFilesMonitorArchiver()
    {
        ...
        serviceCollection.AddSingleton<ILogger<FilesArchiveHostedService>>(NullLogger<FilesArchiveHostedService>.Instance);

        serviceCollection.AddLogFilesMonitorArchiver();
        serviceCollection.AddLogFilesMonitorArchiverConfiguration(configuration);
        ...
        ArchiveProcessorConfig config = ((FilesArchiveHostedService)_hostedServices.First()).Configuration;
